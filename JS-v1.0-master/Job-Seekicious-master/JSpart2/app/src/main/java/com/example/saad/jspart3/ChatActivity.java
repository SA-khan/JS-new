            ...
            chatappSendButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Message != null) {
                        ...
                        /*Firebase senderRef = ref.child(reciever_data.replace(".","/")+"/Messages");
                        Firebase recRef = ref.child(user1.replace(".","/")+"/Messages");
                        String reference = senderRef.push().getKey();
                        Firebase send = senderRef.child(reference);
                        Firebase recieve = recRef.child(reference);
                        send.setValue("Hello");
                        recieve.setValue("Hello");*/
                    }
                }
            });
