...
public class the_Job extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_favorite=(ImageView)findViewById(R.id.favorite_icon);
        ...
        myfrag = (FrameLayout)findViewById(R.id.saadlinear);

        image_favorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                image_favorite.getResources().getColor(R.color.colorPrimaryDark);
            }
        });
                ...
                if(intent1.resolveActivity(getPackageManager())!= null){
                    ...
                    emloyerkey.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            //Intent myintent = new Intent(getApplicationContext(),FragmentOne.class);
                            //startActivity(myintent);
                            getSupportFragmentManager().beginTransaction().add(R.id.saadlinear, myfragment).addToBackStack(null).commit();
